...
| Shipments                  | [operations-shipments.md](./operations-shipments.md)                         | 82    | Validation, duration (ceil days), 7 status buckets, transit-build journal entries, landed-cost clearing workflow, CRUD modals, search/filter                                                                        |
...
| Operations | Shipments              | Documented             | CRUD, transit-build interactions, and landed-cost clearing workflow are documented.                                      |
