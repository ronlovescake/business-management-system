...
| -------------- | ---------------------------------------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Team           | [employees-team.md](employees-team.md)                     | 36    | Employee directory: add/edit/deactivate employees, CSV import/export, status management, contribution defaults.                                                                                                                 |
