...
} from '@/modules/trucking/employees/thirteenth-month-pay/api';

/**
 * Trucking Thirteenth Month Pay API Route
 *
 * Handles CRUD operations for 13th month pay using service layer:
 * - GET: Fetch all trucking records with optional filters
 * - PATCH: Create or update a trucking record (upsert)
 */
