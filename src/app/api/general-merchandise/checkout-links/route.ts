...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.error('Error fetching GM checkout links', error);
...
/**
 * POST /api/general-merchandise/checkout-links
 *
...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.error('Error creating GM checkout links', error);
...
/**
 * PUT /api/general-merchandise/checkout-links
 *
...
export async function PUT(request: NextRequest) {
  try {
    ...
    logger.error('Error updating GM checkout link', error);
    return NextResponse.json(
...
/**
 * DELETE /api/general-merchandise/checkout-links
 *
