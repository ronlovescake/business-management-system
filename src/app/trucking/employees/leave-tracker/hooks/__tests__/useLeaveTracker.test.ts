...
describe('Leave Overlap Detection', () => {
  ...
  it('should detect overlap when dates intersect', () => {
    ...
    expect(
      hasLeaveOverlap('EMP-001', '2024-01-18', '2024-01-25', existing)
    ).toBe(true);
  });
  ...
  it('should detect overlap when new leave contains existing', () => {
    ...
    expect(
      hasLeaveOverlap('EMP-001', '2024-01-15', '2024-01-20', existing)
    ).toBe(true);
  });
  ...
  it('should not detect overlap for separate dates', () => {
    ...
    expect(
      hasLeaveOverlap('EMP-001', '2024-01-25', '2024-01-30', existing)
    ).toBe(false);
  });
  ...
  it('should detect overlap on same start date', () => {
    ...
    expect(
      hasLeaveOverlap('EMP-001', '2024-01-15', '2024-01-25', existing)
    ).toBe(true);
  });
  ...
  it('should detect overlap on same end date', () => {
    ...
    expect(
      hasLeaveOverlap('EMP-001', '2024-01-10', '2024-01-20', existing)
    ).toBe(true);
  });
});
