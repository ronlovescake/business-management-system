...
export class SchedulesErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, _errorInfo: React.ErrorInfo): void {
    logger.error('Schedules module error:', error);
    this.setState({ error });
  }
          ...
          <Paper shadow="md" p="xl" withBorder style={{ maxWidth: 600 }}>
            <Stack gap="md">
              <Stack gap="xs" align="center">
                ...
                <Title order={2}>Schedules Module Error</Title>
              </Stack>
              <Text c="dimmed" ta="center">An error occurred in the schedules module.</Text>
