...
export class InventoryErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, _errorInfo: React.ErrorInfo): void {
    logger.error('Inventory module error:', error);
    this.setState({ error });
  }
          ...
          <Paper shadow="md" p="xl" withBorder style={{ maxWidth: 600 }}>
            <Stack gap="md">
              <Stack gap="xs" align="center">
                ...
                <Title order={2}>Inventory Module Error</Title>
              </Stack>
              <Text c="dimmed" ta="center">An error occurred in the inventory module.</Text>
