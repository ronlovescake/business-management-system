      ...
      <Stack gap="xl">
        ...
        <Grid>
          <Grid.Col span={{ base: 12, md: 8 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder className="modern-card">
              <Stack gap="md">
                <Group justify="space-between">
                  <Title order={3}>Sales Overview</Title>
                  <Badge variant="light" color="blue">This Month</Badge>
                </Group>
                <Box h={300} style={{ 
                  ...
                  <Stack align="center" gap="md">
                    <ThemeIcon size="xl" radius="xl" variant="white" color="pink">
                      <IconChartBar size={28} />
                    </ThemeIcon>
                    <Text size="lg" fw={600}>Sales Analytics</Text>
              ...
              <Card shadow="sm" padding="lg" radius="md" withBorder className="modern-card">
                <Stack gap="md" align="center">
                  ...
                  <RingProgress
                    ...
                    thickness={8}
                    sections={[
                      { value: 68, color: 'pink', tooltip: '68% - Clothing Sales' },
                    ]}
                    label={
                      <Center>
                ...
                <Stack gap="md">
                  ...
                  <Stack gap="xs">
                    ...
                    <Group justify="space-between">
                      ...
                      <Text size="xs" c="dimmed">12 pending</Text>
                    </Group>
                    <Group justify="space-between">
                      <Group gap="sm">
                      ...
                      <Text size="xs" c="dimmed">5 items</Text>
                    </Group>
                  </Stack>
                </Stack>
              </Card>
        ...
        <Card shadow="sm" padding="lg" radius="md" withBorder className="modern-card">
          <Stack gap="md">
            ...
            <Stack gap="sm">
              {[
                { action: 'New summer collection order received', time: '2 minutes ago', color: 'green' },
                { action: 'T-shirt inventory updated', time: '15 minutes ago', color: 'blue' },
                { action: 'Customer size inquiry', time: '1 hour ago', color: 'orange' },
                { action: 'Bulk order shipped to retailer', time: '2 hours ago', color: 'violet' },
              ].map((activity, index) => (
                <Group key={index} justify="space-between" p="sm" style={{ borderRadius: '8px', backgroundColor: 'var(--surface-2)' }}>
                  <Group gap="sm">
                    <ThemeIcon size="sm" radius="sm" variant="light" color={activity.color}>
                      <IconShirt size={14} />
                    </ThemeIcon>
