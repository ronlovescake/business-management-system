...
export class ExpenseService {
   ...
   * Get all expenses
   */
  async findAll(): Promise<TruckingExpense[]> {
    try {
   ...
   * Get expense by ID
   */
  async findById(id: number): Promise<TruckingExpense | null> {
    try {
   ...
   */
  async create(data: ExpenseCreateInput): Promise<TruckingExpense> {
    try {
