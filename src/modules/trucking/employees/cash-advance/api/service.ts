...
export class CashAdvanceService {
   ...
   */
  async findAll(): Promise<TruckingCashAdvanceRecord[]> {
    try {
  ...
  ): Promise<TruckingCashAdvanceRecord[]> {
    try {
   ...
   */
  async findById(id: string): Promise<TruckingCashAdvanceRecord | null> {
    try {
   ...
   */
  async findByEmployeeName(name: string): Promise<TruckingCashAdvanceRecord[]> {
    try {
   ...
   */
  async findByStatus(status: string): Promise<TruckingCashAdvanceRecord[]> {
    try {
   ...
   */
  async findWithBalance(): Promise<TruckingCashAdvanceRecord[]> {
    try {
