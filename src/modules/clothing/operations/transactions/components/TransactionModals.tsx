        ...
        <div>
          ...
          <Stack gap="xs">
            <Text size="sm">
              ...
              Warehouse orders will be updated to &ldquo;Prepared&rdquo; status
            </Text>
            <Text size="sm">
      ...
      <Stack gap="lg">
        ...
        >
          <Text size="sm">
            ...
            &ldquo;Warehouse&rdquo; status orders, sorted by quantity ascending.
          </Text>
        </Alert>
        ...
        <div>
          ...
          <Stack gap="xs">
            ...
            <Text size="sm">• Optimized for warehouse picking operations</Text>
          </Stack>
        </div>
