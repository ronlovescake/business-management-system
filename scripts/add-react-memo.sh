...
FILES=(
  ...
  "src/app/clothing/accounting/components/AnalyticsTable.tsx"
  "src/app/clothing/accounting/components/ReceiptViewerModal.tsx"
  "src/app/clothing/accounting/components/ExpenseControls.tsx"
  "src/app/clothing/accounting/components/ExpenseListTable.tsx"
