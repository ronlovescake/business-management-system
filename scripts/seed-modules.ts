...
const APP_MODULES = [
  ...
  // General Merchandise Business
  {
    ...
    description: 'General merchandise business management',
    sortOrder: 2,
  },
  // General Merchandise Operations
  {
    name: 'general-merchandise-operations',
    displayName: 'Operations',
    path: '/general-merchandise/operations',
    category: 'general-merchandise',
    icon: 'IconBriefcase',
    description: 'General merchandise operations management',
    parentName: 'general-merchandise',
    sortOrder: 1,
  },
  {
    name: 'general-merchandise-operations-checkout-links',
    displayName: 'Invoicing',
    path: '/general-merchandise/operations/checkout-links',
    category: 'general-merchandise',
    icon: 'IconLink',
    parentName: 'general-merchandise-operations',
    sortOrder: 10,
  },
  {
    name: 'general-merchandise-operations-post-template',
    displayName: 'Post Template',
  ...
  {
    name: 'general-merchandise-operations-message-templates',
    displayName: 'Message Templates',
...
async function seedModules() {
  try {
    ...
    for (const moduleData of APP_MODULES) {
      ...
      console.log(`✓ ${moduleData.displayName}`);
    }
    ...
    console.log(`\n✅ Successfully seeded ${count} modules!`);
  } catch (error) {
